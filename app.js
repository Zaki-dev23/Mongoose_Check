...
const users = [
    ...
    {name: 'marouane', age: 18, favoriteFoods: ['sushi', 'pizza']},

    {name: 'brahim', age: 52, favoriteFoods: ['sushi', 'pizza']}
...
Person.deleteMany({ name: 'marouane' })
...
Person.find({favoriteFoods:"couscous"})   // find all user               
